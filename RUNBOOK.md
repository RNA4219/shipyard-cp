...
|------|--------|-------------|----------------|---------------|
| Task作成 | 100% | 483.56 req/s | 2.07ms | 5ms |
| Task取得 | 100% | 192.31 req/s | 5.20ms | 6ms |
| 混合操作 | 96% | 139.21 req/s | 7.18ms | 10ms |
| ヘルスチェック | 100% | 36.08 req/s | 27.71ms | 28ms |
...
- ✅ 高スループット (400+ req/s 作成、190+ req/s 取得)
- ✅ 低レイテンシ (平均 2-7ms)
- ✅ メモリリークなし
- ✅ 100%成功率 (作成・取得)
