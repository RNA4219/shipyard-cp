...
export class OpenCodeSessionRegistry {
  ...
  /**
   * Phase 2C: Legacy isReusable for backward compatibility.
   * @deprecated Use checkReuseEligibility instead.
   */
  private isReusable(record: SessionRecord, criteria: SessionSearchCriteria): boolean {
    const agentProfile = criteria.agentProfile || determineAgentProfile(criteria.stageBucket);
    return this.checkReuseEligibility(record, criteria, agentProfile).eligible;
  }
