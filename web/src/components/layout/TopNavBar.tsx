    ...
    <header className="fixed top-0 left-14 right-0 z-40 h-14 px-3 border-b border-outline-variant/20 bg-surface-container-lowest/80 backdrop-blur-md shadow-sm shadow-black/10">
      <div className="flex items-center justify-between h-full w-full max-w-screen-xl mx-auto">
        ...
        <div className="flex items-center gap-2 md:gap-4 min-w-0">
          <span className="text-on-surface font-bold tracking-tight font-mono text-sm md:text-lg uppercase truncate">
            Shipyard CP
          </span>
        ...
        <div className="flex items-center gap-1 md:gap-2 shrink-0">
          ...
          <div className="relative hidden md:block">
            <span className="material-symbols-outlined absolute left-1.5 top-1/2 -translate-y-1/2 text-on-surface-variant" style={{ fontSize: '16px' }}>
              search
            </span>
            <input
              type="text"
              ...
              className="bg-surface-container-highest border border-outline-variant/20 rounded h-6 pl-6 pr-2 text-xs w-32 lg:w-48 focus:ring-1 focus:ring-primary focus:outline-none font-mono text-on-surface placeholder:text-on-surface-variant/50"
            />
          </div>
          ...
          <div className="flex items-center gap-1 px-1.5 py-0.5 rounded bg-surface-container">
            ...
            />
            <span className="text-[10px] font-mono text-on-surface-variant hidden sm:inline">
          ...
          <Link to="/settings" className="p-1 rounded hover:bg-surface-container transition-colors">
            <span className="material-symbols-outlined text-on-surface-variant" style={{ fontSize: '18px' }}>settings</span>
          </Link>
        </div>
      </div>
    </header>
